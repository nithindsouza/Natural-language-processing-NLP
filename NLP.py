...
import pandas as pd
my_tweet = pd.read_csv("C:/Users/hp/Desktop/NLP assi/Data.csv",usecols=['text'])#loading dataset
...
##################################LDA#################################
article = open('C:/Users/hp/Desktop/NLP assi/NLP-TM.txt' , encoding = "utf8")
